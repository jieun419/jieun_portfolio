export const project5 = {
  ...
  parts: [
    ...
    {
      title: '메인 페이지 UI 및 재미 요소를 추가하기 위해 커서 커스터마이징 구현',
      detail1: [
        '메인 페이지는 독특한 커서 커스터마이징이 돋보이는데, 이미지를 사용하기보다는 마우스 이벤트에 따라 사용자 경험을 개선하기 위해',
        'useRef를 통해 마우스 커서 컴포넌트를 저장하고 requestAnimationFrame() 메서드를 활용해 마우스 동장을 최적화했습니다.',
      ],
      detail:
    ...
    },
    {
      ...
      detail1: [
        ...
        '글자 수 제한, "탈퇴한 사용자" 닉네임은 사용할 수 없도록 작업해 사용자의 악용사례를 방지했습니다.',
      ],
      detail:
    ...
    {
      title: '설정 페이지 UI 작업',
      detail1: ['설정 페이지에 반응형을 적용하고 로그인, 로그아웃 기능을 추가해 사용자 경험을 향상했습니다.'],
    ...
    },
    {
      ...
      detail1: [
        ...
        '로고 디자인도 직접 수행하여 프로젝트의 브랜딩을 기여했습니다.',
      ],
      detail:
  ...
  trouble: [
    {
      ...
      detail1: [
        ...
        'useRef를 통해 마우스 커서 컴포넌트를 저장하고, 스크롤 시에도 이를 유지하고 최적화하기 위해 requestAnimationFrame() 메서드를 활용해 마우스 동장을 최적화했습니다.',
