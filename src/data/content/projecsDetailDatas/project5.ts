export const project5 = {
  ...
  parts: [
    ...
    {
      title: '설정 페이지 작업',
      detail: '설정 페이지에 반응형을 적용하고 로그인, 로그아웃 기능을 추가해 사용자 경험을 향상했습니다.',
    },
    {
  ...
  trouble: [
    {
      ...
      detail:
        '메인 화면의 커서는 초반에 이미지 요소를 고려했으나 마우스 호버시 뚝뚝 끊긴 느낌을 받아 사용자 경험에 부정적인 영향을 줄 것으로 판단했습니다.\n\n여러 구글링을 통해 useRef와 window x, y 축을 알아내는 메서드를 활용해 커서를 커스터마징하게끔 수정했습니다.\n이러한 개선으로 사용자가 버튼에 호버할 때 자연스럽고 부드러운 커서 경험을 제공하면서 많은 긍정적 피드백을 받을 수 있었습니다.',
    },
    {
      title: '팀원들과의 스팩 차이',
      detail:
        '같이 진행하는 팀원들과 월등한 스팩 차이가 났었습니다. 이를 극복하기 위해 메타인지 방식을 활용해 현재 제가 부족한 점이 무엇이고, 팀원들에게 어떤식으로 도움을 줄 수 있는지 파악했습니다.\n\n남들 보다 작업 시간을 더 투자하여 작업 중 모르는 부분은 따로 학습 시간을 가지고, 맡은 역할을 수행했으며, 모르는 부분은 팀원들과 협업하여 해결했습니다. \n\n더불어 제 강점을 살려 HTML, CSS, 디자인 측면을 도와 프로젝트를 성공적으로 마무리할 수 있었습니다.',
    },
  ],
};
