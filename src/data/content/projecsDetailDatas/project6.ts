export const project6 = {
  ...
  parts: [
    {
      title: '프로젝트 기획 및 구체화 작업',
      detail1: [
        '포트폴리오 제작 의도를 파악하고, 간결하면서도 효과적인 순서로 배치했습니다.',
        '커리어 코칭 등을 통해 수용한 피드백을 기반으로 자기 소개, 경력, 프로젝트, 교육 등 중요도 순으로 구성하여,포트폴리오를 보는 사용자들에게 원하는 정보를 쉽게 전달할 수 있도록 고려했습니다.',
        '현재 지속적으로 피드백을 받고 개선하면서 프로젝트를 고도화하고 있습니다.',
      ],
      detail:
        '포트폴리오 제작 의도를 파악하고, 간결하면서도 효과적인 순서로 배치했습니다.\n\n커리어 코칭 등을 통해 수용한 피드백을 기반으로 자기 소개, 경력, 프로젝트, 교육 등 중요도 순으로 구성하여,\n포트폴리오를 보는 사용자들에게 원하는 정보를 쉽게 전달할 수 있도록 고려했습니다.\n\n지속적으로 피드백을 받고 개선하면서 프로젝트를 고도화하고 있습니다.',
    },
    {
      title: '개성을 살려 UI / UX 디자인 (PC, Mobile)',
      detail1: [
        '저만의 개성을 살려 디자인하는 동시에 여러 사용자들이 편안하게 느낄 수 있는 디자인을 추구했습니다.',
        '무채색인 black & white를 활용해 심플하면서도 차분한 느낌을 주었으며, Tooltip, 익숙한 배치 등 UX 측면을 고려하며 사용자 경험을 개선하기 위해 노력했습니다.',
      ],
      detail:
        '저만의 개성을 살려 디자인하는 동시에 여러 사용자들이 편안하게 느낄 수 있는 디자인을 추구했습니다.\n\n무채색인 black & white를 활용해 심플하면서도 차분한 느낌을 주었으며, Tooltip, 익숙한 배치 등 UX 측면을 고려하며 사용자 경험을 개선하기 위해 노력했습니다.',
    },
    {
      ...
      detail1: [
        ...
        '특히, 메인 화면에서는 수용한 피드백을 반영해 애니메이션을 간단하게 구현할 수 있도록 framer-motion라이브러리를 활용했습니다.',
        '이를 통해 첫 화면에 애니메이션 효과를 적용하여 사용자의 시선을 효과적으로 이끌어냈습니다.',
      ],
      detail:
        '직접 디자인한 웹 페이지를 마크업하여 웹 표준을 준수하고 웹 접근성을 고려하며 진행했습니다.\n\n특히, 메인 화면에서는 수용한 피드백을 반영해 애니메이션을 간단하게 구현할 수 있도록 framer-motion라이브러리를 활용했습니다. 이를 통해 첫 화면에 애니메이션 효과를 적용하여 사용자의 시선을 효과적으로 이끌어냈습니다.',
    },
  ],
  trouble: [
    {
      title: '초기 화면이 시선 집중되지 않았던 문제로 framer-motion라이브러리 활용',
      detail1: [
        '초반 피드백을 받았을 때 심플하고 눈에 잘 들어오지 않는다는 피드백을 받았습니다.',
        '피드백을 수용하고 애니메이션 효과를 간단하게 구현할 수 있는 framer-motion라이브러리를 활용해 매끄러운 애니메이션 효과를 구현하고 배경 이미지를 추가했습니다.',
        '이를 통해 사용자의 시선을 효과적으로 이끌어냈고, 긍정적인 피드백을 받을 수 있었습니다.',
      ],
      detail:
    ...
    },
    {
      ...
      detail1: [
        '포트폴리오 사이트를 완성 했다고 마무리 짓지 않고, 지속적으로 개선시켜왔습니다.',
        '여러 프로젝트를 소개하고 있기에 사용자가 쉽게 찾기 어려울 것 같아 고민하게 되었습니다.',
        '이를 해결하기 위해 탭 메뉴를 추가하여 원하는 프로젝트 리스트 바로 찾을 수 있도록 수정했습니다.',
        '또한, [About Me] 섹션을 인터뷰 형식으로 변경하여 저에 대한 정보를 보다 쉽게 전달할 수 있도록 개선했습니다.',
        '이를 통해 원하는 내용을 빠르게 찾고 이해 할 수 있는 사용자 경험을 제공하고자 노력했습니다.',
        '현재는 React Router DOM을 도입해 프로젝트 디테일 modal에 url을 추가할 예정이며 markdown을 통해 가독성 있게 글을 작성하려고 개선 중입니다.',
      ],
      detail:
        '포트폴리오 사이트를 완성 했다고 마무리 짓지 않고, 지속적으로 개선시켜왔습니다.\n\n여러 프로젝트를 소개하고 있기에 사용자가 쉽게 찾기 어려울 것 같아 고민하게 되었습니다.\n이를 해결하기 위해 탭 메뉴를 추가하여 원하는 프로젝트 리스트 바로 찾을 수 있도록 수정했습니다.\n\n또한, [About Me] 섹션을 인터뷰 형식으로 변경하여 저에 대한 정보를 보다 쉽게 전달할 수 있도록 개선했습니다.\n\n이를 통해 원하는 내용을 빠르게 찾고 이해 할 수 있는 사용자 경험을 제공하고자 노력했습니다.\n\n현재는 React Router DOM을 도입해 프로젝트 디테일 modal에 url을 추가할 예정이며, markdown을 통해 가독성 있게 글을 작성하려고 개선 중입니다.',
    },
