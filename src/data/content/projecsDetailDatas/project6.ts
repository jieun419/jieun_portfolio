export const project6 = {
  ...
  parts: [
    ...
    },
    {
      ...
      detail:
        '직접 디자인한 웹 페이지를 마크업하여 웹 표준을 준수하고 웹 접근성을 고려하며 진행했습니다.\n\n특히, 메인 화면에서는 수용한 피드백을 반영해 framer-motion라이브러리를 활용했습니다. 첫 화면에 애니메이션 효과를 적용해 사용자의 시선을 효과적으로 이끌어냈습니다.',
    },
  ],
  trouble: [
    {
