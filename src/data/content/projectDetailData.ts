export const projectDetailData = [
  ...
  },
  {
    ...
    parts: [
      ...
      },
      {
        title: '헤더, 푸터 작업',
        detail:
          '헤더는 스크롤 유무에 따라 스타일을 다르게 줬고, 로그인 후 유저 프로필 사진 클릭 시 메뉴가 나오도록 작업했습니다.\n푸터의 경우 팀원 이름을 마우스 호버 시 역할이 보여지는 재미요소를 넣었고, 클릭 시 팀원 github로 이동 됩니다.',
      },
      {
      ...
      },
      {
        ...
        detail:
          '전반적인 UI 디자인을 맡았고 UX는 팀원들과 함께 상의하여 수정했습니다. 로고 디자인도 직접 진행해 프로젝트의 브랜딩을 제공했습니다.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    parts: [
      ...
      },
      {
        ...
        detail:
          '디자인 시안을 받지 못한 페이지 디자인을 담당했습니다. 이미 디자인되어 있던 기존 페이지와의 일관성을 유지하도록 노력했습니다.',
      },
      {
        title: '반응형 웹 도입을 통한 업무 환경 개선',
        detail:
          '동일한 UI에 배치만 변경되는 프로젝트 구성에서 반응형 웹을 도입하여 PC, Mobile 도메인을 분리하며 작업하던 업무 환경과 작업 효율을 2배로 향상시켰습니다.',
      },
      {
        title: '웹 표준 / 접근성 고려 및 퍼블리싱',
        detail:
  ...
  },
  {
    ...
    parts: [
      ...
      {
        title: '필요에 따라 기획 역할 수행',
        detail:
          '클라이언트가 아직 기획하지 못한 페이지를 기획하고 문서화했습니다. 이를 클라이언트 및 프론트엔드 개발자와 소통하며 프로젝트 방향성을 구체화해 나갔습니다.',
      },
      {
        title: '기타 페이지 디자인 (PC, Mobile)',
        detail: '요구한 로고, 색상 코드, 컨셉에 맞춰 디자인했습니다.',
      },
      {
        title: '레거시 코드 개선을 통한 유지보수성 향상',
        detail:
          '초기 구축할 때 레거시 코드로 구성되어 있었습니다. 예를 들어 table tag 남용, 프로젝트에 사용하지 않는 코드 등을 개선하는 작업을 수행해 코드의 가독성을 높히고 유지보수성을 향상 시켰습니다.',
      },
      {
        title: 'QA 진행을 통한 프로젝트 품질 향상',
        detail:
          'QA를 통해 발견된 문제를 문서화하고, 이를 프론트엔드 개발자와 공유하며 프로젝트의 품질을 지속적으로 향상 시켰습니다.',
      },
      {
        title: '웹 표준 / 접근성 고려 및 퍼블리싱',
        detail:
