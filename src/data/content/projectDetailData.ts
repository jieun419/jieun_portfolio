export const projectDetailData = [
  {
    ...
    tools: [
      ...
      },
      {
        title: 'React',
        detail:
          'React는 컴포넌트 기반으로 하며, 가상 DOM을 활용해 웹 애플리케이션의 성능을 최적화 합니다. \n 컴포넌트 재사용성을 높이고, 상태 관리를 용이하게 할 수 있습니다.',
      },
      {
        title: 'TypeScript',
        detail:
    ...
    parts: [
      {
        title: '기획 및 내용 구체화',
        detail:
          '포트폴리오를 만들려는 의도를 파악하고 순서를 배치 했습니다.\n간단한 자기 소개화 프로젝트, 이력 등 중요도 순으로 배치해 내용을 구성했습니다. 이를 통해 포트폴리오를 보는 사람들에게 원하는 정보를 쉽게 전달할 수 있도록 했습니다.',
      },
      {
        title: 'UI/UX 디자인',
        detail:
          '무채색인 black & white로 심플하고 차분한 느낌을 줬습니다.\n또한 UX 측면을 고려하며 디자인하려고 노력했습니다.',
      },
      {
        title: '퍼블리싱',
        detail: '',
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        title: 'React Query',
        detail:
          'React Query는 React 애플리케이션에서 데이터 가져오기, 관리 및 캐싱을 단순하게 만들어주는 JavaScript 라이브러리입니다.\n서버로부터 데이터를 비동기적으로 가져오고 관리하기 위한 다양한 도구와 패턴을 제공하며, API 요청을 처리하고 캐싱하여 성능을 최적화할 수 있습니다.',
      },
      {
        title: 'Styled Components',
        detail:
    ...
    parts: [
      {
        title: '기획 구성',
        detail:
          '쉽고 간단하게 일정을 만들고 공유할 수 있는 서비스를 제작하고자 했습니다.\nFigma에서 제공하는 Figjam을 활용해 팀원들과 flow chart를 만들고 벤치마킹을 통해 아이디어를 구체화 했습니다.',
      },
      {
        title: '헤더 푸터 작업',
        detail:
      ...
      {
        title: '설정 페이지 작업',
        detail: '설정 페이지 반응형을 적용하고 및 로그인, 로그아웃 기능을 추가해 사용자 경험을 개선했습니다.',
      },
      {
        title: '전반적인 디자인 총괄 및 로고 디자인',
        detail:
          '전반적인 UI 디자인을 맡았습니다. UX는 팀원들과 함께 상의하여 수정했습니다.\n로고 디자인도 직업 진행해 프로젝트의 브랜딩을 제공했습니다.',
      },
    ],
  },
  {
    ...
    parts: [
      {
        ...
        detail:
          '팀원들과 함꼐 오버플로우 홈페이지의 UX를 분석하고 짧은 작업 기간을 고려해 기술들을 레벨로 나눴습니다.',
      },
      {
        title: '질문 작성 / 수정하기 페이지 작업',
        detail:
          '질문 작성 / 수정하기 페이지 작업을 2일 1조로 팀원과 협력하며 진행했습니다.',
      },
      {
  ...
  },
  {
    ...
    tools: [
      {
        title: 'HTML/CSS',
        detail: 'HTML, CSS로 마크업하여 웹 표준을 준수하고 웹 접근성을 고려하며 진행했습니다.',
      },
    ],
    parts: [
      {
        title: '담당자와의 직접적인 소통',
        detail:
          '요구사항 등을 정확히 파악하고 이해하기 위해 직접 소통하며 일정과 요구사항을 체크했습니다.\n또한 개선 사항 등 피드백을 받았을 때 열린 마음으로 수용하며 진행했습니다.',
      },
      {
      ...
      },
      {
        title: '퍼블리싱',
        detail:
          '디자인된 웹 페이지를 HTML, CSS로 마크업하여 웹 표준을 준수하고 웹 접근성을 고려하며 진행했습니다.\n또한 요구사항에 따라 slick slider와 같은 외부 라이브러리를 활용해 동적인 화면을 보여줬습니다. 간단한 토글 버튼과 같은 작업에는 JQuert를 사용해 구현했습니다.',
      },
    ],
  },
  {
    ...
    parts: [
      ...
      },
      {
        ...
        detail:
          '기존 본사 홈페이지를 참고해 홈페이지를 방문했을 때 위화감이 나지 않도록 했습니다. 컨셉인 차분, 단아한 느낌을 살리려고 노력했습니다.\nPC 뿐만 아니라 Mobile환경의 화면도 디자인했습니다.',
      },
      {
        title: '퍼블리싱',
        detail:
