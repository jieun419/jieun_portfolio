export const projectDetailData = [
  ...
  },
  {
    ...
    title: '스택오버플로우',
    subtext:
      '스택오버플로우 사이트를 클론 코딩 하며 프로젝트 경험을 했습니다. 또한 단 기간이였지만 기존 사이트의 UI/UX 측면도 고려하며 진행했습니다.',
    data: '2023.07 - 2023.08',
    team: '6인 (프론트엔드 3명, 백엔드 3명)',
    tag: ['팀', '반응형', '클론코딩'],
  ...
  {
    name: 'coz',
    pointcolor: 'before:bg-[#12175A]',
    title: 'Coz Shopping',
    subtext:
      '코드스테이츠 과제로 주어진 요구 명세서를 확인 하고 요구 하는대로 진행했습니다. 또한 짧은 기간으로 github 학습하는데 많은 도움이 되었습니다.',
    data: '2023.07 - 2023.08',
    team: '1인 (솔로)',
    tag: ['팀', '반응형', '클론코딩'],
